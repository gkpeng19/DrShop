...
<li data-section="Demo Showcase" data-filtertext="responsive tables reflow stack custom styles"><a href="examples/tables@ViewBag.BasePathovie-list.php" data-ajax="false">Reflow: Custom styles</a></li>
...
<li data-section="Demo Showcase" data-filtertext="responsive tables column toggle hide rwd breakpoint customization options"><a href="examples/tables@ViewBag.BasePathovie-list-toggle-options.php" data-ajax="false">Column toggle: Customization options</a></li>
...
<li data-section="Questions & Answers" data-filtertext="HTML 5 inputs appearance keyboard picker calendar date time slider file color"><a href="faq@ViewBag.BasePathy-html-5-inputs-look-different-in-browsers.php">My HTML 5 inputs look different across devices and browsers.</a></li>

<li data-section="Questions & Answers" data-filtertext="range search inputs slider number text degrade"><a href="faq@ViewBag.BasePathy-range-search-input-type-is-being-changed.php">My range or search inputs are being change to number/text.</a></li>
