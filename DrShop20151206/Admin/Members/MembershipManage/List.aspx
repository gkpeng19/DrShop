<%@ Page Title="会员信息管理" Language="C#" MasterPageFile="~/Admin/Basic.Master"
    AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Maticsoft.Web.Admin.Members.MembershipManage.List" %>
        ...
        <cc1:GridViewEx ID="gridView" runat="server" AllowPaging="True" AllowSorting="True"
            ...
            <Columns>
                ...
                <asp:BoundField DataField="Balance" HeaderText="余额" ItemStyle-HorizontalAlign="Center"
                    ...
                    ItemStyle-Width="50" SortExpression="RankScore" Visible="false" />
                ...
                <asp:TemplateField HeaderText="实名认证" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="50">
                    <ItemTemplate>
                        <span>
                            <%#Maticsoft.Common.Globals.SafeBool(Eval("IsUserDPI").ToString(), false) ? "<img src=\"/Areas/SNS/Themes/Default/Content/images/geren.png\" alt=\"实名用户\" title=\"实名用户\">" : ""%></span>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="操作" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="180">
                    <ItemTemplate>
                        ...
                        <br/>
                        <a href='show.aspx?id=<%#Eval("UserID") %>'>详细</a>&nbsp;&nbsp;  <a href='UserLog.aspx?user=<%#Eval("UserName") %>'>日志</a>
                             <a href='/Admin/Members/Points/PointsDetail.aspx?userid=<%#Eval("UserID") %>' style='display:none;'>积分明细</a> 
