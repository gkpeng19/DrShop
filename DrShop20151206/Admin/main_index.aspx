                    ...
                    <div id="tabIndex" style="overflow: scroll; overflow-x: hidden; overflow-y: hidden">
                        ...
                        <div class="main_main">
                            ...
                            <span class="main_time">您最后一次登录的时间：<asp:Literal ID="LitLastLoginTime" runat="server"></asp:Literal>
                                (不是您登录的？<a href="Logout.aspx">请点这里</a>)</span>
                        </div>
                        <div class="main_line">
                        </div>
                        <div class="main_iconmenu" style="line-height: normal">
                            <span>
                                <a src="SysManage/WebSiteConfig.aspx" href="javascript:;" target="mainFrame">
                                    <img src="images/mian_webSit.png" width="48" height="48" /><br />
                                    网站设置 
                                </a>
                            </span>
                            <%--<span>
                                <a src="CMS/Content/List.aspx?type=0" href="javascript:;" target="mainFrame">
                                <img src="images/main_contentManage.png" width="48" height="48" /><br />
                                内容管理</a>
                            </span>--%>
                            <span><a src="Members/MembershipManage/list.aspx" href="javascript:;"
                                    target="mainFrame">
                        ...
                        <div class="main_tj" style="display: none">
                            <a src="sysmanage/treefavorite.aspx" href="javascript:;" target="mainFrame">添加新的快捷功能</a>
                        </div>
                        ...
                        <div class="main_bottomzi">
                            <ul>
                                ...
                                <li><a src="SNS/SearchWord/SearchLog.aspx" href="javascript:;">查看搜索记录</a></li>
                            </ul>
                            <ul>
                        ...
                        <div class="admintitle adminxia">
                            <div class="sj" style="margin-right: 20px;">
                                <img src="images/icon_3.gif" width="21" height="28" />
                            </div>
                            <strong>系统环境</strong>
                        </div>
