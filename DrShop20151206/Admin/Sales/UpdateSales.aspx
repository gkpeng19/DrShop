<%@ Page Title="编辑业务员信息" Language="C#" MasterPageFile="~/Admin/Basic.Master" AutoEventWireup="true"
    CodeBehind="UpdateSales.aspx.cs" Inherits="Maticsoft.Web.Admin.Sales.UpdateSales" %>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="borderkuang">
                <tr>
                    <td bgcolor="#FFFFFF" class="newstitle">
                        <asp:Literal ID="Literal1" runat="server" Text="编辑业务员用户信息" />
                    </td>
                </tr>
                <tr>
                    <td bgcolor="#FFFFFF" class="newstitlebody">
                        <asp:Literal ID="Literal6" runat="server" Text="您可以进行编辑业务员用户操作" />
                    </td>
                </tr>
            </table>
        </div>
                    ...
                    <table cellspacing="0" cellpadding="3" width="100%" border="0">
                        ...
                        <tr style="display: none">
                            ...
                            <td height="25">
                                ...
                                <asp:RangeValidator ControlToValidate="txtEmployeeID" ID="RangeValidator2" runat="server"
                                    Display="Dynamic" Type="Integer" MinimumValue="1" MaximumValue="999999999" ErrorMessage="<%$ Resources:Site, TooltipFormatErr %>"></asp:RangeValidator>
                            </td>
                        </tr>
                        <tr>
                            <td class="td_class">
                            ...
                            <td height="25">
                                <asp:CheckBox ID="chkActive" runat="server" Text="<%$ Resources:Sysmanage,lblFrozenAccount %>"
                                    Checked="false" />
                            </td>
                        </tr>
                        <tr>
