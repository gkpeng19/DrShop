<%@ Page Title="订单管理" Language="C#" MasterPageFile="~/Admin/Basic.Master" AutoEventWireup="true"
    CodeBehind="OrdersList.aspx.cs" Inherits="Maticsoft.Web.Admin.Sales.OrdersList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            if (type != null) {
                $("a:[href='OrdersList.aspx?id=" + userId + "&type=" + type + "']").parents("li").removeClass(NotSelectedCss);
                $("a:[href='OrdersList.aspx?id=" + userId + "&type=" + type + "']").parents("li").addClass(SelectedCss);
            } else {
                $("a:[href='OrdersList.aspx?id=" + userId + "&type=0']").parents("li").removeClass(NotSelectedCss);
                $("a:[href='OrdersList.aspx?id=" + userId + "&type=0']").parents("li").addClass(SelectedCss);
            }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="newslistabout">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="borderkuang">
                ...
                <tr>
                    <td bgcolor="#FFFFFF" class="newstitlebody">
                        <asp:Literal ID="lblTitle" runat="server" Text="您可以根据订单状态查询" />
                    </td>
                </tr>
            </table>
        </div>
        ...
        <div class="nTab4">
            <div class="TabTitle">
                <ul id="myTab1">
                    <li class="normal"><a href='OrdersList.aspx?id=<%=UserId %>&type=0' style="padding-top: 5px;">
                        <asp:Literal ID="Literal7" runat="server" Text="近三个月订单"></asp:Literal></a></li>
                    <li class="normal" id="tabPaying" style="display: none"><a href='OrdersList.aspx?id=<%=UserId %>&type=1'>
                        <asp:Literal ID="Literal8" runat="server" Text="等待付款"></asp:Literal></a></li>
                    <li class="normal" id="tabPreHandle" style="display: none"><a href='OrdersList.aspx?id=<%=UserId %>&type=2'>
                        <asp:Literal ID="Literal9" runat="server" Text="等待处理"></asp:Literal></a></li>
                    <li class="normal" id="tabCancel" style="display: none"><a href='OrdersList.aspx?id=<%=UserId %>&type=3'>
                    ...
                    <li runat="server" visible="false" class="normal" id="tabLocking" style="display: none">
                        <a href='OrdersList.aspx?id=<%=UserId %>&type=4'>
                            <asp:Literal ID="Literal13" runat="server" Text="订单锁定"></asp:Literal></a></li>
                    <li class="normal" id="tabPreConfirm" style="display: none"><a href='OrdersList.aspx?id=<%=UserId %>&type=5'>
                        <asp:Literal ID="Literal14" runat="server" Text="等待付款确认"></asp:Literal></a></li>
                    <li class="normal" id="tabHandling" style="display: none"><a href='OrdersList.aspx?id=<%=UserId %>&type=6'>
                        <asp:Literal ID="Literal15" runat="server" Text="正在处理"></asp:Literal></a></li>
                    <li class="normal" id="tabShipping" style="display: none"><a href='OrdersList.aspx?id=<%=UserId %>&type=7'>
                        <asp:Literal ID="Literal16" runat="server" Text="配货中"></asp:Literal></a></li>
                    <li class="normal" id="tabShiped" style="display: none"><a href='OrdersList.aspx?id=<%=UserId %>&type=8'>
                        <asp:Literal ID="Literal17" runat="server" Text="已发货"></asp:Literal></a></li>
                    <li class="normal" id="tabSuccess" style="display: none"><a href='OrdersList.aspx?id=<%=UserId %>&type=9'>
                        <asp:Literal ID="Literal5" runat="server" Text="已完成"></asp:Literal></a></li>
                    <li class="normal" id="tabHistory" style="display: none"><a href='OrdersList.aspx?id=<%=UserId %>&type=-1'>
            ...
            <Columns>
                ...
                <asp:TemplateField ControlStyle-Width="160" HeaderText="订单操作" ItemStyle-HorizontalAlign="Left">
                    <ItemTemplate>
                        ...
                        <a class="iframe" style="border: 1px #1317fc solid; padding-left: 5px; padding-right: 5px;
                            margin-right: 5px; padding-top: 2px; padding-bottom: 2px; white-space: nowrap;"
                            href="/Admin/Shop/Order/OrderShow.aspx?orderId=<%#Eval("OrderId") %>&type=<%#Type%>">
                            查看</a>
                        <%--     <asp:LinkButton ID="LinkButton1" runat="server" CausesValidation="False" CommandName="Pay"
                            Style="display: none; border: 1px #1317fc solid; padding-left: 5px; padding-right: 5px;
                        ...
                        <%--     <a class="iframe ShipAction" shippingstatus="<%# Eval("ShippingStatus")%>" orderstatus='<%# Eval("OrderStatus")%>'
                            ...
                            border: 1px #1317fc solid; padding-left: 5px; padding-right: 5px; margin-right: 5px;
                            padding-top: 2px; padding-bottom: 2px; white-space: nowrap;">配货</a> <a class="iframeShiped ShipedAction"
                                shippingstatus="<%# Eval("ShippingStatus")%>" orderstatus='<%# Eval("OrderStatus")%>'
                                href="OrderShip.aspx?orderId=<%#Eval("OrderId") %>" style="display: none; border: 1px #1317fc solid;
                        ...
                        <asp:LinkButton ID="linkCancel" Style="display: none; border: 1px #1317fc solid;
                            padding-left: 5px; padding-right: 5px; margin-right: 5px; padding-top: 2px; padding-bottom: 2px;
