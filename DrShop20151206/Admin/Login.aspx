                        ...
                        <tr style="display:none;">
                            ...
                            <td width="135">
                                <div class="newsadd_title">
                                    <ul>
                                        <li id="uboxstyle">
                                            <asp:DropDownList name="select" ID="dropLanguage" runat="server">
                    ...
                    <table width="90%" border="0" cellspacing="0" cellpadding="0">
                        ...
                        <tr>
                            ...
                            <td height="30">
                                ...
                                <img id="ImageCheck" onclick="ChangeCode()" src="/ValidateCode.aspx" tooltip="验证码" />
                            </td>
                        </tr>
                        <tr>
