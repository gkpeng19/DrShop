<%@ Page Title="编辑配送方式" Language="C#" MasterPageFile="~/Admin/Basic.Master" AutoEventWireup="true" CodeBehind="UpdateShipType.aspx.cs" Inherits="Maticsoft.Web.Admin.Shop.Shipping.UpdateShipType" %>
        ...
        <div class="TabContent">
                        ...
                        <td class="tdbg">
                            <table cellspacing="0" cellpadding="3" width="100%" border="0">
                                ...
                                <tr>
                                    ...
                                    <td height="25">
                                        <asp:TextBox ID="tWeight" TabIndex="2" runat="server" Width="250px" MaxLength="20" Text="0"></asp:TextBox>（克）
                                ...
                                <tr>
                                    ...
                                    <td height="25">
                                        <asp:TextBox ID="tAddWeight" TabIndex="3" runat="server" Width="250px" MaxLength="20" Text="0"></asp:TextBox>（克）
                                ...
                                <tr>
                                    ...
                                    <td height="25">
                                        <asp:TextBox ID="tPrice" TabIndex="2" runat="server" Width="250px" MaxLength="20" Text="0"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="td_class">
                                    ...
                                    <td height="25">
                                        <asp:TextBox ID="tAddPrice" TabIndex="3" runat="server" Width="250px" MaxLength="20" Text="0"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="td_class">
                                ...
                                <div ng-controller="RegionCtrl">
                                    <span>您已设置 {{regions.length}} 个地区价格</span>
                                        <table id="RegionSave" style="width: 380px;" cellpadding="2" cellspacing="1" class="GridViewTyle">
                                            <tr height="25px" style="background-color: #CCCCCC; height: 25px; background: #FFF">
                                                <th scope="col" style="border: 1px solid #dae2e8; border-right: 0px;">
                                                    地区
                                                </th>
                                                ...
                                                <th scope="col" style="border: 1px solid #dae2e8; border-left: 0px;">
                                                    操作
                                                </th>
                                            </tr>
                                    ...
                                    <div style="margin-top: 20px;">
                                        <table id="Table1" style="width: 380px;" cellpadding="2" cellspacing="1" class="GridViewTyle">
                                            <tr height="25px" style="background-color: #CCCCCC; height: 25px; background: #FFF">
                                                <th scope="col" colspan="4" style="border: 1px solid #dae2e8;">
                                                    新增地区价格
                                                </th>
                                            </tr>
                                            <tr height="27px" onmouseover="currentcolor=this.style.backgroundColor;this.style.backgroundColor='#CBE3F4';" onmouseout="this.style.backgroundColor=currentcolor" style="height: 25px; background-color: rgb(255, 255, 255);  background-position: initial initial; background-repeat: initial initial;">
                                                ...
                                                <td align="center" height="27px" style="padding-left: 5px; height: 27px;">
                                                    <input type="button" class="adminsubmit_short" ng-click="addRegion()" value="添加" />
                                                </td>
                                            </tr>
                                        </table>
                                    </div>
            ...
            <table style="width: 100%; border-top: none; float: left;" cellpadding="2" cellspacing="1" class="border">
                <tr>
                    ...
                    <td height="25">
                        <asp:Button ID="Button1" runat="server" Text="<%$ Resources:Site, btnSaveText %>" OnClick="btnSave_Click" OnClientClick="return sub()" class="adminsubmit_short"></asp:Button>
                        <asp:Button ID="Button2" runat="server" CausesValidation="false" Text="<%$ Resources:Site, btnCancleText %>" OnClick="btnCancle_Click" class="adminsubmit_short"></asp:Button>
                    </td>
                </tr>
                <tr>
                    <td colspan="2">
