...
Inherits="Maticsoft.Web.Admin.Shop.ExpressTemplate.Copy" Title="添加相似快递单" %>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="borderkuang">
                <tr>
                    <td bgcolor="#FFFFFF" class="newstitle">
                        <asp:Literal ID="Literal3" runat="server" Text="添加相似快递单" />
                    </td>
                </tr>
                <tr>
                    <td bgcolor="#FFFFFF" class="newstitlebody">
                        <asp:Literal ID="Literal4" runat="server" Text="您可以添加相似快递单" />
                    </td>
                </tr>
            </table>
        </div>
