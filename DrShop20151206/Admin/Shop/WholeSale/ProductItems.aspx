<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/BasicNoFoot.Master" AutoEventWireup="true"
    CodeBehind="ProductItems.aspx.cs" Inherits="Maticsoft.Web.Admin.Shop.WholeSale.ProductItems" %>
                                ...
                                <table width="100%" border="0" cellspacing="0" class="conlisttd" productid="<%# Eval("ProductId") %>"
                                        ...
                                        <td width="14%" rowspan="3" class="img">
                                            <div class="borderImage">
                                                <a href="/Product/Detail/<%# Eval("ProductId") %>" target="_blank">
                                                    <img id="ThumbnailUrl40" src="<%# @Maticsoft.Web.Components.FileHelper.GeThumbImage(Eval("ThumbnailUrl1").ToString(), "T128X130_") %>"
                                    ...
                                    <tr>
                                        ...
                                        <td width="15%" valign="top">
                                            <a href="javascript:void(0);"><span class="submit_add">添加</span></a>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td valign="top">
                                ...
                                <table width="100%" border="0" cellspacing="0" class="conlisttd">
                                    <tr>
                                        <td width="14%" rowspan="3" class="img">
                                            <div class="borderImage">
                                                <a href="/Product/Detail/<%# Eval("ProductId") %>" target="_blank">
                                                    <img id="Img1" src="<%# @Maticsoft.Web.Components.FileHelper.GeThumbImage(Eval("ThumbnailUrl1").ToString(), "T128X130_") %>"
                                                        width="80px" height="80px" /></a></div>
                                        </td>
                                        <td height="27" colspan="5" class="br_none">
                                            <span class="Name"><a href='/Product/Detail/<%# Eval("ProductId") %>' target="_blank">
