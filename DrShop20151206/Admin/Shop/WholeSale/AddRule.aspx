<%@ Page Language="C#" Title="添加批发规则" MasterPageFile="~/Admin/BasicNoFoot.Master"
    AutoEventWireup="true" CodeBehind="AddRule.aspx.cs" Inherits="Maticsoft.Web.Admin.Shop.WholeSale.AddRule" %>
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="borderkuang">
                            ...
                            <tr>
                                ...
                                <td height="35" class="td_content">
                                    <asp:TextBox ID="txtRuleName" runat="server" CssClass="marginstyle"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td class="td_class" style="background-color: #E2E8EB">
                    ...
                    <td style="vertical-align: top;">
                        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="borderkuang">
                            ...
                            <tr>
                                ...
                                <td height="25">
                                    <asp:CheckBoxList ID="ChkUserRank" runat="server" RepeatDirection="Horizontal" align="left">
                                    </asp:CheckBoxList>
                                </td>
                            </tr>
                            <%--<tr>
