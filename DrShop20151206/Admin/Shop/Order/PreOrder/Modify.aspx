<%@ Page Language="C#" MasterPageFile="~/Admin/BasicNoFoot.Master" AutoEventWireup="true"
    CodeBehind="Modify.aspx.cs" Inherits="Maticsoft.Web.Shop.Order.PreOrder.Modify" Title="修改页" %>
...
<table cellSpacing="0" cellPadding="0" width="100%" border="0">
    ...
    <tr>
            ...
            <td>   <asp:Button ID="btnSave" runat="server" Text="<%$ Resources:Site, btnSaveText %>"
