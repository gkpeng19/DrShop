<%@ Page Title="订单打印管理" Language="C#" MasterPageFile="~/Admin/Basic.Master" AutoEventWireup="true"
    CodeBehind="OrderPrints.aspx.cs" Inherits="Maticsoft.Web.Admin.Shop.Order.OrderPrints" %>
                    ...
                    <ItemTemplate>
                        <a class="iframe" style="border: 1px #1317fc solid; padding-left: 5px; padding-right: 5px;
                            ...
                            href="OrderShow.aspx?orderId=<%#Eval("OrderId") %>&type=<%#Type%>">查看</a>
                             <a class="btnPrint" style="border: 1px #1317fc solid; padding-left: 5px; padding-right: 5px;
                            margin-right: 5px; padding-top: 2px; padding-bottom: 2px; white-space: nowrap;"
