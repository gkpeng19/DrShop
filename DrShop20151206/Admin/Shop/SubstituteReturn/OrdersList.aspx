<%@ Page Title="代退货" Language="C#" MasterPageFile="~/Admin/Basic.Master" AutoEventWireup="true"
    CodeBehind="OrdersList.aspx.cs" Inherits="Maticsoft.Web.Admin.Shop.SubstituteReturn.OrdersList" %>
            ...
            <Columns>
                ...
                <asp:TemplateField ControlStyle-Width="80" HeaderText="操作" ItemStyle-HorizontalAlign="center">
                    <ItemTemplate>
                        ...
                        <a suppid="<%# Eval("SupplierId")%>"   class="Apply iframe" oi="<%# Eval("OrderId")%>"  os="<%# Eval("OrderStatus")%>"  href="Apply.aspx?OrderId=<%#Eval("OrderId") %>"  style="display:none;border: 1px #1317fc solid; padding-left: 5px; padding-right: 5px; margin-right: 5px;
