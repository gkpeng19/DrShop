<%@ Page Title="POS机签到记录" Language="C#" MasterPageFile="~/Admin/Basic.Master"
    AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Maticsoft.Web.Pay.CMBC_LogCheckIn.List" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="borderkuang">
                <tr>
                    <td bgcolor="#FFFFFF" class="newstitle">
                         <asp:Literal ID="Literal1" runat="server" Text="POS机签到记录" />
                    </td>
                </tr>
                <tr>
                    <td bgcolor="#FFFFFF" class="newstitlebody">
                        您可以查看 <asp:Literal ID="Literal3" runat="server" Text="POS机签到记录" />
                    </td>
                </tr>
            </table>
        </div>
    ...
    <cc1:GridViewEx ID="gridView" runat="server" AllowPaging="True" AllowSorting="True"
		...
		<asp:BoundField DataField="TERM_ID" HeaderText="终端编号" SortExpression="TERM_ID" ItemStyle-HorizontalAlign="Center"  /> 
		 <asp:TemplateField ControlStyle-Width="50" HeaderText="交易日期"   ItemStyle-HorizontalAlign="Center"  Visible="false">
                                <ItemTemplate>
                                 <%# Eval("INST_DATE")%>  
                                </ItemTemplate>
                            </asp:TemplateField>
		...
		<asp:BoundField DataField="LOGIN_TYPE" HeaderText="登录类型" SortExpression="LOGIN_TYPE" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="RESERVE" HeaderText="保留域" SortExpression="RESERVE" ItemStyle-HorizontalAlign="Center"   Visible="false" /> 
